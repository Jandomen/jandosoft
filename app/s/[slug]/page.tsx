  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 transition-colors">
          ...
          <div className="max-w-lg mx-auto space-y-4">
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm hover:shadow-md transition-all p-6 md:p-8 space-y-4">
              ...
              {(store as any).whatsappPhone && (
                <div className="pt-2">
                  <a href={`https://wa.me/${(store as any).whatsappPhone.replace(/[^0-9]/g, "")}`}
                    target="_blank" rel="noopener noreferrer"
                    className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold text-xs transition-all active:scale-[0.97] bg-[#25D366] text-white hover:bg-[#1ebe57]">
      ...
      {(store as any).whatsappPhone && (
        <a href={`https://wa.me/${(store as any).whatsappPhone.replace(/[^0-9]/g, "")}`}
          target="_blank" rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-xl hover:bg-[#1ebe57] hover:scale-110 transition-all active:scale-95"
          title="WhatsApp">
