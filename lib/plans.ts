...
export const PLANS: PlanConfig[] = [
  ...
  },
  {
    ...
    limits: { maxStores: 1, maxProductsPerStore: 10, maxMessages: 10, maxAutomations: 1, maxAppointments: 5, maxCampaigns: 1, maxCustomers: 50 },
  },
  {
    id: "tacos",
    ...
    limits: { maxStores: 1, maxProductsPerStore: 25, maxMessages: 20, maxAutomations: 3, maxAppointments: 10, maxCampaigns: 3, maxCustomers: 100 },
  },
  {
    id: "siesta",
    name: "La Siesta",
    ...
    limits: { maxStores: 2, maxProductsPerStore: 50, maxMessages: 30, maxAutomations: 5, maxAppointments: 20, maxCampaigns: 5, maxCustomers: 200 },
  },
  {
    id: "mandado",
    name: "El Mandado",
    ...
    limits: { maxStores: 3, maxProductsPerStore: 100, maxMessages: 50, maxAutomations: 10, maxAppointments: 50, maxCampaigns: 10, maxCustomers: 500 },
  },
  {
    id: "huevito",
    name: "El Huevito",
    ...
    price: 249,
    desc: "El mes completo, como Dios manda",
    ...
    limits: { maxStores: 5, maxProductsPerStore: 200, maxMessages: 100, maxAutomations: 20, maxAppointments: 100, maxCampaigns: 20, maxCustomers: 1000 },
  },
  {
    id: "comal",
    name: "El Comal",
    ...
    limits: { maxStores: 10, maxProductsPerStore: 500, maxMessages: 200, maxAutomations: 50, maxAppointments: 200, maxCampaigns: 50, maxCustomers: 3000 },
  },
  {
    id: "hacienda",
    name: "La Hacienda",
    ...
    price: 999,
    desc: "Medio año de lujo, sin preocupaciones",
    ...
    limits: { maxStores: 20, maxProductsPerStore: 1000, maxMessages: 500, maxAutomations: 100, maxAppointments: 500, maxCampaigns: 100, maxCustomers: 10000 },
  },
];
