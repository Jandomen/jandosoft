...
export const PLANS: PlanConfig[] = [
  ...
  },
  {
    ...
    limits: { maxStores: 1, maxProductsPerStore: 10, maxMessages: 10, maxAutomations: 1, maxAppointments: 5, maxCampaigns: 1, maxCustomers: 50, maxWhatsAppNumbers: 0, maxWhatsAppMessagesPerDay: 0, maxWhatsAppTemplates: 0, maxWhatsAppCampaigns: 0 },
  },
  {
    id: "tacos",
    ...
    limits: { maxStores: 1, maxProductsPerStore: 25, maxMessages: 20, maxAutomations: 3, maxAppointments: 10, maxCampaigns: 3, maxCustomers: 100, maxWhatsAppNumbers: 0, maxWhatsAppMessagesPerDay: 0, maxWhatsAppTemplates: 0, maxWhatsAppCampaigns: 0 },
  },
  {
    id: "siesta",
    name: "La Siesta",
    ...
    limits: { maxStores: 2, maxProductsPerStore: 50, maxMessages: 30, maxAutomations: 5, maxAppointments: 20, maxCampaigns: 5, maxCustomers: 200, maxWhatsAppNumbers: 1, maxWhatsAppMessagesPerDay: 50, maxWhatsAppTemplates: 3, maxWhatsAppCampaigns: 2 },
  },
  {
    id: "mandado",
    name: "El Mandado",
    ...
    limits: { maxStores: 3, maxProductsPerStore: 100, maxMessages: 50, maxAutomations: 10, maxAppointments: 50, maxCampaigns: 10, maxCustomers: 500, maxWhatsAppNumbers: 1, maxWhatsAppMessagesPerDay: 100, maxWhatsAppTemplates: 5, maxWhatsAppCampaigns: 3 },
  },
  {
    id: "huevito",
    name: "El Huevito",
    ...
    limits: { maxStores: 5, maxProductsPerStore: 200, maxMessages: 100, maxAutomations: 20, maxAppointments: 100, maxCampaigns: 20, maxCustomers: 1000, maxWhatsAppNumbers: 2, maxWhatsAppMessagesPerDay: 200, maxWhatsAppTemplates: 15, maxWhatsAppCampaigns: 5 },
  },
  {
    id: "comal",
    name: "El Comal",
    ...
    limits: { maxStores: 10, maxProductsPerStore: 500, maxMessages: 200, maxAutomations: 50, maxAppointments: 200, maxCampaigns: 50, maxCustomers: 3000, maxWhatsAppNumbers: 3, maxWhatsAppMessagesPerDay: 500, maxWhatsAppTemplates: 50, maxWhatsAppCampaigns: 20 },
  },
  {
    id: "hacienda",
    name: "La Hacienda",
    ...
    limits: { maxStores: 20, maxProductsPerStore: 1000, maxMessages: 500, maxAutomations: 100, maxAppointments: 500, maxCampaigns: 100, maxCustomers: 10000, maxWhatsAppNumbers: 5, maxWhatsAppMessagesPerDay: 1000, maxWhatsAppTemplates: 100, maxWhatsAppCampaigns: 50 },
  },
];
...
export function buildComparisonFeatures(
  ...
  const limitsList: { labelKey: string; key: keyof PlanLimits }[] = [
    ...
    { labelKey: "plans.limit_whatsapp_campaigns", key: "maxWhatsAppCampaigns" },
  ];
